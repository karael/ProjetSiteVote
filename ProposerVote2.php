...
<h3> Proposer un vote à choix multiple</h3>
	<p>Vous avez choisie de proposer un vote à choix multiple </p>
	<div class="formulaire">
	<form id="ajout_vote" method="post" action="ProposerVote2.php?action=inserVote">
            <table>
                <tbody>
                    <tr>
                        <td> Sujet :</td> 
