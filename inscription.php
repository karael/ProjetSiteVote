...
<div class="inscription-main content">
    <div class="production-info agenda">
        ...
        <p> Votre compte donne au servive Vote en ligne. Si vous disposez déjà d'un compte, vous pouvez <a href="index.php"> vous connecter ici.</a></p>
    </div>
    <div class="formulaire">
        <h2> Premier pas avec Vote en ligne </h2>
