...
<h3> Ajouter un vote à choix multiple</h3>
	<p>Vous avez choisie d\'ajouter un vote à choix multiple </p>
	<div class="formulaire">
	<form id="ajout_vote" method="post" action="insererVote2.php?action=inserVote">
            <table>
                <tbody>
                    <tr>
                        <td> Sujet :</td> 
