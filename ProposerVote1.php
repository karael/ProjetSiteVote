...
<h3> Proposer un vote à choix unique</h3>
	<p>Vous avez choisie de proposer un vote à choix unique </p>
	<div class="formulaire">
	<form id="ajout_vote" method="post" action="ProposerVote1.php?action=inserVote">
            <table>
                <tbody>
                    <tr>
                        <td> Sujet :</td> 
